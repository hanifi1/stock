...
class Stock_model(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, data_fetcher):
        ...
        # self.svm = SVR(kernel='rbf',gamma=0.5, C=10, epsilon = 0.05)
        # self.lr = LinearRegression()
        self.lr = SVR(kernel='rbf',gamma=0.5, C=10, epsilon = 0.05)
    ...
    def predict(self, X, Y=None):
        ...
        # predictions = self.svm.predict(df_features)
